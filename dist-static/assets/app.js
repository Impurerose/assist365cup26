...
function R$1(a, b, e2, d, c2) {
  ...
  if (h) return h = a, c2 = c2(h), a = "" === d ? "." + Q$1(h, 0) : d, I$1(c2) ? (e2 = "", null != a && (e2 = a.replace(P$1, "$&/") + "/"), R$1(c2, b, e2, "", function(a2) {
    return a2;
  })) : null != c2 && (O$1(c2) && (c2 = N$1(c2, e2 + (!c2.key || h && h.key === c2.key ? "" : ("" + c2.key).replace(P$1, "$&/") + "/") + a)), b.push(c2)), 1;
  h = 0;
  d = "" === d ? "." : d + ":";
  ...
  else if (f2 = A$1(a), "function" === typeof f2) for (a = f2.call(a), g = 0; !(k2 = a.next()).done; ) k2 = k2.value, f2 = d + Q$1(k2, g++), h += R$1(k2, b, e2, f2, c2);
...
function q(c2, a, g) {
  ...
  return { $$typeof: k, type: c2, key: e2, ref: h, props: d, _owner: n$1.current };
}
...
(function(exports$1) {
  function f2(a, b) {
    ...
    a: for (; 0 < c2; ) {
      var d = c2 - 1 >>> 1, e2 = a[d];
      if (0 < g(e2, b)) a[d] = b, a[c2] = e2, c2 = d;
      else break a;
    }
  }
  function h(a) {
  ...
  function k2(a) {
    ...
    if (c2 !== b) {
      ...
      a: for (var d = 0, e2 = a.length, w2 = e2 >>> 1; d < w2; ) {
        ...
        if (0 > g(C2, c2)) n2 < e2 && 0 > g(x2, C2) ? (a[d] = x2, a[n2] = c2, d = n2) : (a[d] = C2, a[m2] = c2, d = m2);
        else if (n2 < e2 && 0 > g(x2, c2)) a[d] = x2, a[n2] = c2, d = n2;
        else break a;
      }
    }
    return b;
  ...
  exports$1.unstable_scheduleCallback = function(a, b, c2) {
    ...
    e2 = c2 + e2;
    a = { id: u2++, callback: b, priorityLevel: a, startTime: c2, expirationTime: e2, sortIndex: -1 };
    c2 > d ? (a.sortIndex = c2, f2(t2, a), null === h(r2) && a === h(t2) && (B2 ? (E2(L2), L2 = -1) : B2 = true, K2(H2, c2 - d))) : (a.sortIndex = e2, f2(r2, a), A2 || z2 || (A2 = true, I2(J2)));
    return a;
  };
...
function ta(a, b, c2, d) {
  ...
  if (null !== e2 ? 0 !== e2.type : d || !(2 < b.length) || "o" !== b[0] && "O" !== b[0] || "n" !== b[1] && "N" !== b[1]) qa(b, c2, e2, d) && (c2 = null), d || null === e2 ? oa(b) && (null === c2 ? a.removeAttribute(b) : a.setAttribute(b, "" + c2)) : e2.mustUseProperty ? a[e2.propertyName] = null === c2 ? 3 === e2.type ? false : "" : c2 : (b = e2.attributeName, d = e2.attributeNamespace, null === c2 ? a.removeAttribute(b) : (e2 = e2.type, c2 = 3 === e2 || 4 === e2 && true === c2 ? "" : "" + c2, d ? a.setAttributeNS(d, b, c2) : a.setAttribute(b, c2)));
}
...
function fb(a, b, c2, d) {
  ...
  if (b) {
    ...
    for (c2 = 0; c2 < a.length; c2++) e2 = b.hasOwnProperty("$" + a[c2].value), a[c2].selected !== e2 && (a[c2].selected = e2), e2 && d && (a[c2].defaultSelected = true);
  } else {
    c2 = "" + Sa(c2);
    b = null;
...
function Nb(a, b, c2, d, e2, f2, g, h, k2) {
...
function Tb(a, b, c2, d, e2, f2, g, h, k2) {
  Ob = false;
  Pb = null;
  Nb.apply(Sb, arguments);
}
function Ub(a, b, c2, d, e2, f2, g, h, k2) {
...
function uc(a, b) {
  ...
  if (0 === c2) return 0;
  var d = 0, e2 = a.suspendedLanes, f2 = a.pingedLanes, g = c2 & 268435455;
  if (0 !== g) {
    var h = g & ~e2;
  ...
  0 !== (d & 4) && (d |= c2 & 16);
  b = a.entangledLanes;
  if (0 !== b) for (a = a.entanglements, b &= d; 0 < b; ) c2 = 31 - oc(b), e2 = 1 << c2, d |= a[c2], b &= ~e2;
  return d;
}
function vc(a, b) {
  switch (a) {
...
function wc(a, b) {
  for (var c2 = a.suspendedLanes, d = a.pingedLanes, e2 = a.expirationTimes, f2 = a.pendingLanes; 0 < f2; ) {
...
function Tc(a, b, c2, d, e2, f2) {
  if (null === a || a.nativeEvent !== f2) return a = { blockedOn: b, domEventName: c2, eventSystemFlags: d, nativeEvent: f2, targetContainers: [e2] }, null !== b && (b = Cb(b), null !== b && Fc(b)), a;
  a.eventSystemFlags |= d;
  b = a.targetContainers;
  null !== e2 && -1 === b.indexOf(e2) && b.push(e2);
  return a;
}
function Uc(a, b, c2, d, e2) {
  switch (b) {
    case "focusin":
      return Lc = Tc(Lc, a, b, c2, d, e2), true;
    case "dragenter":
      return Mc = Tc(Mc, a, b, c2, d, e2), true;
    case "mouseover":
      return Nc = Tc(Nc, a, b, c2, d, e2), true;
    case "pointerover":
      var f2 = e2.pointerId;
      Oc.set(f2, Tc(Oc.get(f2) || null, a, b, c2, d, e2));
      return true;
    case "gotpointercapture":
      return f2 = e2.pointerId, Pc.set(f2, Tc(Pc.get(f2) || null, a, b, c2, d, e2)), true;
  }
  return false;
}
function Vc(a) {
...
function fd(a, b, c2, d) {
  if (dd) {
    var e2 = Yc(a, b, c2, d);
    if (null === e2) hd(a, b, d, id, c2), Sc(a, d);
    else if (Uc(e2, a, b, c2, d)) d.stopPropagation();
...
function nd() {
  if (md) return md;
  var a, b = ld, c2 = b.length, d, e2 = "value" in kd ? kd.value : kd.textContent, f2 = e2.length;
...
function pf(a, b, c2, d) {
  ...
  d ? void 0 !== e2 ? a.addEventListener(b, c2, { capture: true, passive: e2 }) : a.addEventListener(b, c2, true) : void 0 !== e2 ? a.addEventListener(b, c2, { passive: e2 }) : a.addEventListener(b, c2, false);
}
function hd(a, b, c2, d, e2) {
  var f2 = d;
  ...
  Jb(function() {
    ...
    if (0 === (b & 7)) {
      ...
      ba && (de && "ko" !== c2.locale && (ie || "onCompositionStart" !== ba ? "onCompositionEnd" === ba && ie && ($a = nd()) : (kd = e3, ld = "value" in kd ? kd.value : kd.textContent, ie = true)), xa = oe(d2, ba), 0 < xa.length && (ba = new Ld(ba, a, null, c2, e3), g2.push({ event: ba, listeners: xa }), $a ? ba.data = $a : ($a = he(c2), null !== $a && (ba.data = $a))));
      if ($a = ce ? je(a, c2) : ke(a, c2)) d2 = oe(d2, "onBeforeInput"), 0 < d2.length && (e3 = new Ld("onBeforeInput", "beforeinput", null, c2, e3), g2.push({ event: e3, listeners: d2 }), e3.data = $a);
    }
    se(g2, b);
  });
}
...
function oe(a, b) {
  for (var c2 = b + "Capture", d = []; null !== a; ) {
    ...
    5 === e2.tag && null !== f2 && (e2 = f2, f2 = Kb(a, c2), null != f2 && d.unshift(tf(a, f2, e2)), f2 = Kb(a, b), null != f2 && d.push(tf(a, f2, e2)));
    a = a.return;
  }
  return d;
}
...
function Og(a) {
  ...
  function k2(a2, b2, c3, d2) {
    ...
    if (null !== b2 && (b2.elementType === f3 || "object" === typeof f3 && null !== f3 && f3.$$typeof === Ha && Ng(f3) === b2.type)) return d2 = e2(b2, c3.props), d2.ref = Lg(a2, b2, c3), d2.return = a2, d2;
  ...
  function r2(a2, b2, c3, d2) {
    ...
    if ("string" === typeof c3 && "" !== c3 || "number" === typeof c3) return null !== e3 ? null : h(a2, b2, "" + c3, d2);
    if ("object" === typeof c3 && null !== c3) {
      switch (c3.$$typeof) {
        case va:
          return c3.key === e3 ? k2(a2, b2, c3, d2) : null;
        case wa:
          return c3.key === e3 ? l2(a2, b2, c3, d2) : null;
        case Ha:
      ...
      if (eb(c3) || Ka(c3)) return null !== e3 ? null : m2(a2, b2, c3, d2, null);
      Mg(a2, c3);
    }
    return null;
  }
  function y2(a2, b2, c3, d2, e3) {
    if ("string" === typeof d2 && "" !== d2 || "number" === typeof d2) return a2 = a2.get(c3) || null, h(b2, a2, "" + d2, e3);
    if ("object" === typeof d2 && null !== d2) {
      switch (d2.$$typeof) {
        case va:
          return a2 = a2.get(null === d2.key ? c3 : d2.key) || null, k2(b2, a2, d2, e3);
        case wa:
          return a2 = a2.get(null === d2.key ? c3 : d2.key) || null, l2(b2, a2, d2, e3);
        case Ha:
          var f3 = d2._init;
          return y2(a2, b2, c3, f3(d2._payload), e3);
      }
      if (eb(d2) || Ka(d2)) return a2 = a2.get(c3) || null, m2(b2, a2, d2, e3, null);
      Mg(b2, d2);
    }
    return null;
  }
  ...
  function J2(a2, d2, f3, h2) {
    ...
    return "string" === typeof f3 && "" !== f3 || "number" === typeof f3 ? (f3 = "" + f3, null !== d2 && 6 === d2.tag ? (c2(a2, d2.sibling), d2 = e2(d2, f3), d2.return = a2, a2 = d2) : (c2(a2, d2), d2 = Qg(f3, a2.mode, h2), d2.return = a2, a2 = d2), g(a2)) : c2(a2, d2);
  }
  return J2;
}
...
function ii(a, b, c2) {
  var d = yi(a), e2 = { lane: d, action: c2, hasEagerState: false, eagerState: null, next: null };
  if (zi(a)) Ai(b, e2);
  else {
    var f2 = a.alternate;
    ...
    c2 = hh(a, b, e2, d);
    null !== c2 && (e2 = R(), gi(c2, a, d, e2), Bi(c2, b, d));
  }
}
function zi(a) {
  var b = a.alternate;
...
var Ei = { isMounted: function(a) {
  ...
  a = a._reactInternals;
  var c2 = R(), d = yi(a), e2 = mh(c2, d);
  e2.tag = 2;
  void 0 !== b && null !== b && (e2.callback = b);
  b = nh(a, e2, d);
  null !== b && (gi(b, a, d, c2), oh(b, a, d));
} };
function Fi(a, b, c2, d, e2, f2, g) {
  a = a.stateNode;
  return "function" === typeof a.shouldComponentUpdate ? a.shouldComponentUpdate(d, f2, g) : b.prototype && b.prototype.isPureReactComponent ? !Ie(c2, d) || !Ie(e2, f2) : true;
}
function Gi(a, b, c2) {
  var d = false, e2 = Vf;
...
function Si(a, b, c2) {
  ...
  e2.has(c2) || (e2.add(c2), a = Ti.bind(null, a, b, c2), b.then(a, a));
}
function Ui(a) {
  do {
    var b;
...
function $i(a, b, c2, d, e2) {
  if (null === a) {
    var f2 = c2.type;
    if ("function" === typeof f2 && !aj(f2) && void 0 === f2.defaultProps && null === c2.compare && void 0 === c2.defaultProps) return b.tag = 15, b.type = f2, bj(a, b, f2, d, e2);
    a = Rg(c2.type, null, d, b, b.mode, e2);
    a.ref = b.ref;
    a.return = b;
    return b.child = a;
  }
  ...
  if (0 === (a.lanes & e2)) {
    ...
    c2 = c2.compare;
    c2 = null !== c2 ? c2 : Ie;
    if (c2(g, d) && a.ref === b.ref) return Zi(a, b, e2);
  }
  b.flags |= 1;
  a = Pg(f2, d);
  a.ref = b.ref;
...
function cj(a, b, c2, d, e2) {
  var f2 = Zf(c2) ? Xf : H.current;
  f2 = Yf(b, f2);
  ch(b, e2);
  c2 = Nh(a, b, c2, d, f2, e2);
  d = Sh();
  if (null !== a && !dh) return b.updateQueue = a.updateQueue, b.flags &= -2053, a.lanes &= ~e2, Zi(a, b, e2);
  I && d && vg(b);
  b.flags |= 1;
...
function hj(a, b, c2, d, e2) {
  if (Zf(c2)) {
    var f2 = true;
    cg(b);
  } else f2 = false;
  ch(b, e2);
  if (null === b.stateNode) ij(a, b), Gi(b, c2, d), Ii(b, c2, d, e2), d = true;
  else if (null === a) {
  ...
  return jj(a, b, c2, d, f2, e2);
}
function jj(a, b, c2, d, e2, f2) {
  gj(a, b);
  var g = 0 !== (b.flags & 128);
  if (!d && !g) return e2 && dg(b, c2, false), Zi(a, b, f2);
  d = b.stateNode;
  Wi.current = b;
...
function oj(a, b, c2) {
  ...
  e2 = a.memoizedState;
  if (null !== e2 && (h = e2.dehydrated, null !== h)) return rj(a, b, g, d, h, e2, c2);
  if (f2) {
    f2 = d.fallback;
    g = b.mode;
    e2 = a.child;
...
function wj(a, b, c2, d, e2) {
  var f2 = a.memoizedState;
  null === f2 ? a.memoizedState = { isBackwards: b, rendering: null, renderingStartTime: 0, last: d, tail: c2, tailMode: e2 } : (f2.isBackwards = b, f2.rendering = null, f2.renderingStartTime = 0, f2.last = d, f2.tail = c2, f2.tailMode = e2);
}
function xj(a, b, c2) {
...
function S(a) {
  ...
  if (b) for (var e2 = a.child; null !== e2; ) c2 |= e2.lanes | e2.childLanes, d |= e2.subtreeFlags & 14680064, d |= e2.flags & 14680064, e2.return = a, e2 = e2.sibling;
  else for (e2 = a.child; null !== e2; ) c2 |= e2.lanes | e2.childLanes, d |= e2.subtreeFlags, d |= e2.flags, e2.return = a, e2 = e2.sibling;
  a.subtreeFlags |= d;
  a.childLanes = c2;
  return b;
}
function Ej(a, b, c2) {
  ...
  switch (b.tag) {
    ...
    case 5:
      ...
      c2 = b.type;
      if (null !== a && null != b.stateNode) Bj(a, b, c2, d, e2), a.ref !== b.ref && (b.flags |= 512, b.flags |= 2097152);
      else {
        if (!d) {
...
function gi(a, b, c2, d) {
  ...
  Ac(a, c2, d);
  if (0 === (K & 2) || a !== Q) a === Q && (0 === (K & 2) && (qk |= c2), 4 === T && Ck(a, Z$1)), Dk(a, d), 1 === c2 && 0 === K && 0 === (b.mode & 1) && (Gj = B() + 500, fg && jg());
}
function Dk(a, b) {
...
function Gk(a, b) {
  ...
  if (0 !== b) {
    ...
    if (6 === b) Ck(a, d);
      ...
      if (0 === (d & 30) && !Ok(e2) && (b = Ik(a, d), 2 === b && (f2 = xc(a), 0 !== f2 && (d = f2, b = Nk(a, f2))), 1 === b)) throw c2 = pk, Kk(a, 0), Ck(a, d), Dk(a, B()), c2;
      a.finishedWork = e2;
      a.finishedLanes = d;
      switch (b) {
        case 0:
...
function Wk(a, b, c2, d) {
  ...
  mc(c2.stateNode);
  Dk(a, B());
  if (null !== b) for (d = a.onRecoverableError, c2 = 0; c2 < b.length; c2++) e2 = b[c2], d(e2.value, { componentStack: e2.stack, digest: e2.digest });
...
Vk = function(a, b, c2) {
  ...
  switch (b.tag) {
    ...
    case 16:
      ...
      return b;
    case 0:
      return d = b.type, e2 = b.pendingProps, e2 = b.elementType === d ? e2 : Ci(d, e2), cj(a, b, d, e2, c2);
    case 1:
      return d = b.type, e2 = b.pendingProps, e2 = b.elementType === d ? e2 : Ci(d, e2), hj(a, b, d, e2, c2);
    case 3:
      a: {
        kj(b);
      ...
      return b;
    case 5:
      return Ah(b), null === a && Eg(b), d = b.type, e2 = b.pendingProps, f2 = null !== a ? a.memoizedProps : null, g = e2.children, Ef(d, e2) ? g = null : null !== f2 && Ef(d, f2) && (b.flags |= 32), gj(a, b), Xi(a, b, g, c2), b.child;
    case 6:
    ...
    case 11:
      return d = b.type, e2 = b.pendingProps, e2 = b.elementType === d ? e2 : Ci(d, e2), Yi(a, b, d, e2, c2);
    case 7:
    ...
    case 10:
      a: {
        ...
        Xi(a, b, e2.children, c2);
        b = b.child;
      }
      return b;
    case 9:
      return e2 = b.type, d = b.pendingProps.children, ch(b, c2), e2 = eh(e2), d = d(e2), b.flags |= 1, Xi(a, b, d, c2), b.child;
    case 14:
      return d = b.type, e2 = Ci(d, b.pendingProps), e2 = Ci(d.type, e2), $i(a, b, d, e2, c2);
    case 15:
      return bj(a, b, b.type, b.pendingProps, c2);
    case 17:
      return d = b.type, e2 = b.pendingProps, e2 = b.elementType === d ? e2 : Ci(d, e2), ij(a, b), b.tag = 1, Zf(d) ? (a = true, cg(b)) : a = false, ch(b, c2), Gi(b, d, e2), Ii(b, d, e2, c2), jj(null, b, d, true, a, c2);
    case 19:
      return xj(a, b, c2);
    case 22:
      return dj(a, b, c2);
...
function bl(a, b, c2, d, e2, f2, g, h, k2) {
...
function el(a, b, c2, d, e2, f2, g, h, k2) {
  a = bl(c2, d, true, a, e2, f2, g, h, k2);
  a.context = dl(null);
  c2 = a.current;
  d = R();
  e2 = yi(c2);
...
reactDom_production_min.createRoot = function(a, b) {
  ...
  b = bl(a, 1, false, null, null, c2, false, d, e2);
  a[uf] = b.current;
  sf(8 === a.nodeType ? a.parentNode : a);
  return new ll(b);
};
...
reactDom_production_min.hydrateRoot = function(a, b, c2) {
  ...
  b = el(b, null, a, 1, null != c2 ? c2 : null, e2, false, f2, g);
  a[uf] = b.current;
  sf(a);
  if (d) for (a = 0; a < d.length; a++) c2 = d[a], e2 = c2._getVersion, e2 = e2(c2._source), null == b.mutableSourceEagerHydrationData ? b.mutableSourceEagerHydrationData = [c2, e2] : b.mutableSourceEagerHydrationData.push(
    c2,
    e2
  );
  return new ml(b);
...
const e$1 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("path", { d: "M176,156a43.78,43.78,0,0,0-29.09,11L106.1,140.8a44.07,44.07,0,0,0,0-25.6L146.91,89a43.83,43.83,0,1,0-13-20.17L93.09,95a44,44,0,1,0,0,65.94L133.9,187.2A44,44,0,1,0,176,156Zm0-120a20,20,0,1,1-20,20A20,20,0,0,1,176,36ZM64,148a20,20,0,1,1,20-20A20,20,0,0,1,64,148Zm112,72a20,20,0,1,1,20-20A20,20,0,0,1,176,220Z" }))
  ],
  [
    "duotone",
    ...
    ), /* @__PURE__ */ reactExports.createElement("path", { d: "M176,160a39.89,39.89,0,0,0-28.62,12.09l-46.1-29.63a39.8,39.8,0,0,0,0-28.92l46.1-29.63a40,40,0,1,0-8.66-13.45l-46.1,29.63a40,40,0,1,0,0,55.82l46.1,29.63A40,40,0,1,0,176,160Zm0-128a24,24,0,1,1-24,24A24,24,0,0,1,176,32ZM64,152a24,24,0,1,1,24-24A24,24,0,0,1,64,152Zm112,72a24,24,0,1,1,24-24A24,24,0,0,1,176,224Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("path", { d: "M212,200a36,36,0,1,1-69.85-12.25l-53-34.05a36,36,0,1,1,0-51.4l53-34a36.09,36.09,0,1,1,8.67,13.45l-53,34.05a36,36,0,0,1,0,24.5l53,34.05A36,36,0,0,1,212,200Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("path", { d: "M176,162a37.91,37.91,0,0,0-28.3,12.67L98.8,143.24a37.89,37.89,0,0,0,0-30.48l48.9-31.43a38,38,0,1,0-6.5-10.09L92.3,102.67a38,38,0,1,0,0,50.66l48.9,31.43A38,38,0,1,0,176,162Zm0-132a26,26,0,1,1-26,26A26,26,0,0,1,176,30ZM64,154a26,26,0,1,1,26-26A26,26,0,0,1,64,154Zm112,72a26,26,0,1,1,26-26A26,26,0,0,1,176,226Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("path", { d: "M176,160a39.89,39.89,0,0,0-28.62,12.09l-46.1-29.63a39.8,39.8,0,0,0,0-28.92l46.1-29.63a40,40,0,1,0-8.66-13.45l-46.1,29.63a40,40,0,1,0,0,55.82l46.1,29.63A40,40,0,1,0,176,160Zm0-128a24,24,0,1,1-24,24A24,24,0,0,1,176,32ZM64,152a24,24,0,1,1,24-24A24,24,0,0,1,64,152Zm112,72a24,24,0,1,1,24-24A24,24,0,0,1,176,224Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("path", { d: "M176,164a36,36,0,0,0-27.92,13.3L96.25,144a35.92,35.92,0,0,0,0-32L148.08,78.7A35.93,35.93,0,1,0,143.75,72L91.92,105.3a36,36,0,1,0,0,45.4L143.75,184A36,36,0,1,0,176,164Zm0-136a28,28,0,1,1-28,28A28,28,0,0,1,176,28ZM64,156a28,28,0,1,1,28-28A28,28,0,0,1,64,156Zm112,72a28,28,0,1,1,28-28A28,28,0,0,1,176,228Z" }))
  ]
]);
...
const o$1 = reactExports.createContext({
  color: "currentColor",
  size: "1em",
  weight: "regular",
  mirrored: false
...
const e = reactExports.forwardRef((r2, t$12) => /* @__PURE__ */ reactExports.createElement(p, { ref: t$12, ...r2, weights: t }));
e.displayName = "CaretDownIcon";
const s$1 = e;
const o = reactExports.forwardRef((r2, t2) => /* @__PURE__ */ reactExports.createElement(p, { ref: t2, ...r2, weights: e$1 }));
o.displayName = "ShareNetworkIcon";
const n = o;
const c = reactExports.forwardRef((e2, r2) => /* @__PURE__ */ reactExports.createElement(p, { ref: r2, ...e2, weights: Z }));
c.displayName = "SoccerBallIcon";
const s = c;
...
const BASE_CLASSES = "whitespace-nowrap overflow-hidden text-ellipsis font-semibold rounded-xl transition-all duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-offset-0";
const SIZE_CLASSES = {
  small: {
...
const VARIANT_STYLES = {
  default: {
    primary: {
      active: "bg-[#006FE8] focus:bg-[#0059BA] text-white hover:bg-[#0059BA] active:bg-[#004A9C] focus:ring-[#C2DFFF] focus:ring-opacity-100",
      disabled: "bg-[#C8C9CB] text-[#70777C] cursor-not-allowed pointer-events-none"
    },
    secondary: {
      active: "bg-white border-2 border-[#006FE8] text-[#006FE8] hover:border-[#0059BA] hover:text-[#0059BA] active:border-[#004A9C] active:text-[#004A9C] focus:border-[#0059BA] focus:text-[#0059BA] focus:border-transparent focus:ring-[#006FE8] focus:ring-opacity-100",
      disabled: "bg-white border-2 border-[#C8C9CB] text-[#70777C] cursor-not-allowed pointer-events-none"
    },
    tertiary: {
      active: "text-[#006FE8] hover:text-[#0059BA] active:text-[#004A9C] focus:border-[#0059BA] focus:text-[#0059BA] focus:border-transparent focus:ring-[#C2DFFF] focus:ring-opacity-100",
      disabled: "text-[#70777C] cursor-not-allowed pointer-events-none"
    }
  },
  alt: {
    primary: {
      active: "bg-[#BDEDE7] text-[#31363A] hover:bg-[#A8E5DD] active:bg-[#93DDD3] focus:bg-[#BDEDE7] focus:ring-[#7BD0C2] focus:ring-opacity-100",
      disabled: "bg-[#E0E0E0] text-[#70777C] cursor-not-allowed pointer-events-none"
    },
    secondary: {
      active: "bg-transparent border-2 border-white text-white hover:bg-white hover:bg-opacity-10 active:bg-white active:bg-opacity-20 focus:bg-transparent focus:ring-white focus:ring-opacity-50",
      disabled: "bg-transparent border-2 border-[#C8C9CB] text-[#70777C] cursor-not-allowed pointer-events-none"
    },
    tertiary: {
      active: "bg-transparent text-[#BDEDE7] hover:text-[#A8E5DD] active:text-[#93DDD3] focus:border-transparent focus:text-[#BDEDE7] focus:ring-[#7BD0C2] focus:ring-opacity-100",
...
const Button = ({
  ...
  trackClass = "",
  iconSize,
  // eslint-disable-line no-unused-vars -- Extraído para evitar pasarlo al DOM
  ...props
}) => {
  var _a, _b, _c;
  const sizeClass = ((_a = SIZE_CLASSES[size]) == null ? void 0 : _a[mode]) || SIZE_CLASSES.large.default;
  const variantStyle = ((_c = (_b = VARIANT_STYLES[variant]) == null ? void 0 : _b[color]) == null ? void 0 : _c[disabled ? "disabled" : "active"]) || "";
  ...
  const renderIcon = () => {
    ...
    return React.cloneElement(icon, {
      className: classNames((_a2 = icon.props) == null ? void 0 : _a2.className, iconClass, "flex-shrink-0")
    });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${classes || ""} ${fullWidth ? "w-full" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: buttonClasses, disabled, ...props, children: cleanButton ? children : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    iconPosition === "left" && renderIcon(),
    children,
    iconPosition === "right" && renderIcon()
  ] }) }) });
};
const SoccerBallGradient = () => /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "0", height: "0", className: "absolute", children: /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "soccerGradient", x1: "0%", y1: "0%", x2: "0%", y2: "100%", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#59D3C2", stopOpacity: 1 }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "#006FE8", stopOpacity: 1 })
] }) }) });
function HeaderBar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-white w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between w-full max-w-[1200px] mx-auto px-6 py-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SoccerBallGradient, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "32", height: "32", viewBox: "0 0 32 32", className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(s, { size: 32, weight: "duotone", style: { fill: "url(#soccerGradient)" } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold text-[#0059BA]", children: "World Cup Map 2026" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(n, { size: 16, weight: "bold" }),
        iconPosition: "left",
        children: "Compartir"
      }
    )
...
const isDeepEqual = /* @__PURE__ */ getDefaultExportFromCjs(fastDeepEqual);
const VERSION = "1.7.1";
    ...
    const loadApi = () => {
      ...
      apiPromise = new Promise((resolve, reject) => {
        ...
        for (const [key, value] of Object.entries(params)) {
          const urlParamName = key.replace(/[A-Z]/g, (t2) => "_" + t2[0].toLowerCase());
...
function useMapInstances() {
  const [mapInstances, setMapInstances] = reactExports.useState({});
  const addMapInstance = (mapInstance, id2 = "default") => {
    setMapInstances((instances) => Object.assign(Object.assign({}, instances), { [id2]: mapInstance }));
  };
  const removeMapInstance = (id2 = "default") => {
    setMapInstances((_a) => {
      var _b = id2;
      _a[_b];
...
function useGoogleMapsApiLoader(props) {
  ...
  const [status, setStatus] = reactExports.useState(GoogleMapsApiLoader.loadingStatus);
  const [loadedLibraries, addLoadedLibrary] = reactExports.useReducer((loadedLibraries2, action) => {
  ...
  const librariesString = reactExports.useMemo(() => libraries === null || libraries === void 0 ? void 0 : libraries.join(","), [libraries]);
  const serializedParams = reactExports.useMemo(() => JSON.stringify(Object.assign({ apiKey, version }, otherApiParams)), [apiKey, version, otherApiParams]);
  const importLibrary = reactExports.useCallback((name) => __awaiter(this, void 0, void 0, function* () {
    var _a;
...
function useInternalUsageAttributionIds(props) {
  const internalUsageAttributionIds = reactExports.useMemo(() => props.disableUsageAttribution ? null : DEFAULT_INTERNAL_USAGE_ATTRIBUTION_IDS, [props.disableUsageAttribution]);
...
function useCustomCompareEffect(effect, dependencies, isEqual) {
  reactExports.useEffect(effect, [useMemoized(dependencies, isEqual)]);
}
function useDeepCompareEffect(effect, dependencies) {
  useCustomCompareEffect(effect, dependencies, isDeepEqual);
}
const mapOptionKeys = /* @__PURE__ */ new Set([
  "backgroundColor",
  "clickableIcons",
  "controlSize",
  "disableDefaultUI",
...
function useApiLoadingStatus() {
  var _a;
  return ((_a = reactExports.useContext(APIProviderContext)) === null || _a === void 0 ? void 0 : _a.status) || APILoadingStatus.NOT_LOADED;
}
...
function useCallbackRef() {
  const [el2, setEl] = reactExports.useState(null);
  const ref = reactExports.useCallback((value) => setEl(value), [setEl]);
  return [el2, ref];
}
...
function useMapInstance(props, context) {
  ...
  const savedMapStateRef = reactExports.useRef(void 0);
  reactExports.useEffect(
    () => {
...
const Map$1 = (props) => {
  ...
  const context = reactExports.useContext(APIProviderContext);
  ...
  const cameraOptions = reactExports.useMemo(() => {
    var _a, _b, _c;
    return {
  ...
  const combinedStyle = reactExports.useMemo(() => Object.assign({
    width: "100%",
    height: "100%",
    position: "relative",
  ...
  const contextValue = reactExports.useMemo(() => ({ map }), [map]);
  ...
  return React.createElement("div", Object.assign({ ref: mapRef, "data-testid": "map", style: className ? void 0 : combinedStyle, className }, id2 ? { id: id2 } : {}), map ? React.createElement(GoogleMapsContext.Provider, { value: contextValue }, children) : null);
};
...
const useMap = (id2 = null) => {
  const ctx = reactExports.useContext(APIProviderContext);
  const { map } = reactExports.useContext(GoogleMapsContext) || {};
  if (ctx === null) {
...
const AdvancedMarker = reactExports.forwardRef((props, ref) => {
  const { children, style, className, anchorPoint } = props;
  const [marker, contentContainer] = useAdvancedMarker(props);
  const advancedMarkerContextValue = reactExports.useMemo(() => marker ? { marker } : null, [marker]);
  reactExports.useImperativeHandle(ref, () => marker, [marker]);
  if (!contentContainer)
    return null;
  return React.createElement(AdvancedMarkerContext.Provider, { value: advancedMarkerContextValue }, reactDomExports.createPortal(React.createElement(MarkerContent, { anchorPoint, styles: style, className }, children), contentContainer));
});
...
function useAdvancedMarker(props) {
  ...
  const [contentContainer, setContentContainer] = reactExports.useState(null);
  const map = useMap();
  ...
  const numChildren = reactExports.Children.count(children);
  reactExports.useEffect(() => {
...
function useAdvancedMarkerAnchoring(marker, anchorPoint, anchorLeft, anchorTop, hasChildren) {
  reactExports.useEffect(() => {
    ...
    if (anchorPoint !== void 0) {
      const [x2, y2] = anchorPoint !== null && anchorPoint !== void 0 ? anchorPoint : AdvancedMarkerAnchorPoint["BOTTOM"];
      const translateX = `calc(-1 * ${x2})`;
      const translateY = `calc(-1 * ${y2})`;
      if (anchorOptionsSupported) {
...
function useMarker(props) {
  ...
  reactExports.useEffect(() => {
    ...
    if (onClick)
      gme.addListener(m2, "click", onClick);
    if (onDrag)
      gme.addListener(m2, "drag", onDrag);
    if (onDragStart)
      gme.addListener(m2, "dragstart", onDragStart);
    if (onDragEnd)
      gme.addListener(m2, "dragend", onDragEnd);
    if (onMouseOver)
      gme.addListener(m2, "mouseover", onMouseOver);
    if (onMouseOut)
      gme.addListener(m2, "mouseout", onMouseOut);
    marker.setDraggable(Boolean(draggable));
    return () => {
      gme.clearInstanceListeners(m2);
    };
  }, [
    marker,
    draggable,
...
const Marker = reactExports.forwardRef((props, ref) => {
...
const VenueMarker = ({ venue, onClick }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdvancedMarker, { position: venue.coordinates, onClick, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2 cursor-pointer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full flex items-center justify-center border-3 border-white shadow-lg bg-gradient-to-b from-[#59D3C2] to-[#006FE8]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(s, { size: 28, weight: "duotone", className: "text-white" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white px-3 py-1 rounded-lg shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#0059BA] font-bold text-sm whitespace-nowrap", children: venue.name }) })
  ] }) });
};
function MapContent({ selectedCity, setSelectedCity }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: VENUES.map((venue) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    VenueMarker,
    {
      venue,
...
function MapContainer({ selectedTeam, selectedCity, setSelectedCity }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl overflow-hidden w-[790px] h-[640px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(APIProvider, { apiKey: "AIzaSyBTLpnFO7BWQeVpblahIGHDLYzjVzF61oQ", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Map$1,
    {
      ...
      ...MAP_CONFIG,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapContent, { selectedCity, setSelectedCity })
    }
  ) }) });
}
const Chip = ({
  ...
  const sizeClasses = size === "small" ? "text-base py-[6px]" : "text-lg py-[10px]";
  const chipClasses = classNames(
    `font-semibold rounded-full transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-0 ${sizeClasses}`,
    {
      ...
      "bg-transparent border-2 border-[#C2DFFF] text-[#70777C] hover:border-[#006FE8] hover:text-[#31363A] active:border-[#006FE8] active:text-[#31363A]": variant === "default" && color === "primary" && !disabled && state === "default",
      // Default variant and primary color - selected state
      "bg-transparent border-2 border-[#006FE8] text-[#31363A] hover:border-[#006FE8] hover:text-[#31363A] active:border-[#006FE8] active:text-[#31363A]": variant === "default" && color === "primary" && !disabled && state === "selected",
      // Disabled state (default variant, primary color)
      "bg-transparent border-2 border-gray-300 text-gray-400 cursor-not-allowed pointer-events-none": variant === "default" && color === "primary" && disabled || variant === "alt" && color === "primary" && disabled,
      // Default variant and secondary color - default state
      "bg-white border-2 border-blue-600 text-blue-600 hover:border-3 hover:border-blue-700 hover:text-blue-700 active:border-blue-800 active:text-blue-800 focus:border-blue-700 focus:text-blue-700 focus:ring-blue-700 focus:ring-opacity-100": variant === "default" && color === "secondary" && !disabled && state === "default",
      // Default variant and secondary color - selected state
      "bg-white border-2 border-blue-600 text-blue-600 hover:border-3 hover:border-blue-600 hover:text-gray-800 active:border-blue-800 active:text-blue-800 focus:border-blue-700 focus:text-blue-700 focus:ring-blue-700 focus:ring-opacity-100": variant === "default" && color === "secondary" && !disabled && state === "selected",
      "bg-white border-2 border-gray-300 text-gray-400 cursor-not-allowed pointer-events-none": variant === "default" && color === "secondary" && disabled,
      // Default variant and tertiary color - default state
      "bg-transparent text-blue-600 hover:text-blue-700 active:text-blue-800 focus:text-blue-700 focus:ring-blue-200 focus:ring-opacity-100": variant === "default" && color === "tertiary" && !disabled && state === "default",
      // Default variant and tertiary color - selected state
      "bg-transparent text-blue-600 hover:text-gray-800 active:text-blue-800 focus:text-blue-700 focus:ring-blue-200 focus:ring-opacity-100": variant === "default" && color === "tertiary" && !disabled && state === "selected",
      "bg-transparent text-gray-400 cursor-not-allowed pointer-events-none": variant === "default" && color === "tertiary" && disabled,
      // Alt variant and primary color - default state
      "bg-transparent border-2 border-teal-300 text-teal-300 hover:border-3 hover:border-white hover:text-white active:bg-white active:bg-opacity-10 focus:border-teal-300 focus:ring-teal-400 focus:ring-opacity-100": variant === "alt" && color === "primary" && !disabled && state === "default",
      // Alt variant and primary color - selected state
      "bg-transparent border-2 border-teal-300 text-teal-300 hover:border-3 hover:border-teal-300 hover:text-teal-300 active:bg-white active:bg-opacity-10 focus:border-teal-300 focus:ring-teal-400 focus:ring-opacity-100": variant === "alt" && color === "primary" && !disabled && state === "selected"
    }
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classNames(wrapperClasses, classes), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: chipClasses,
      ...props,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: style_childrenWrapper, children })
    }
  ) });
};
const TeamCard = ({ team, onClick }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "button",
  {
    onClick: () => onClick(team),
    className: "bg-white rounded-lg p-4 flex items-center gap-3 hover:shadow-md transition-shadow",
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: team.flag }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-gray-800", children: team.name })
    ]
  }
);
const MatchCard = ({ match }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white border border-[#C2DFFF] rounded-xl px-3 py-4 flex flex-col gap-4 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-[7px] top-[7px] w-5 h-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "10", cy: "10", r: "10", fill: "#006FE8" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "text",
        {
          x: "10",
          ...
          children: match.number
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: match.team1.flag }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-semibold text-[#31363A]", style: { fontFamily: "Titillium Web, sans-serif" }, children: match.team1.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-semibold text-[#31363A]", style: { fontFamily: "Titillium Web, sans-serif" }, children: "-" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-semibold text-[#31363A]", style: { fontFamily: "Titillium Web, sans-serif" }, children: match.team2.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: match.team2.flag })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "3.125", y: "3.125", width: "13.75", height: "13.75", rx: "1.25", fill: "#7BD0C2", opacity: "0.2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M15.625 6.25H4.375C3.68464 6.25 3.125 6.80964 3.125 7.5V15.625C3.125 16.3154 3.68464 16.875 4.375 16.875H15.625C16.3154 16.875 16.875 16.3154 16.875 15.625V7.5C16.875 6.80964 16.3154 6.25 15.625 6.25Z", stroke: "#7BD0C2", strokeWidth: "1.25", strokeLinecap: "round", strokeLinejoin: "round" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M13.125 3.75V6.25", stroke: "#7BD0C2", strokeWidth: "1.25", strokeLinecap: "round", strokeLinejoin: "round" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M6.875 3.75V6.25", stroke: "#7BD0C2", strokeWidth: "1.25", strokeLinecap: "round", strokeLinejoin: "round" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-[#31363A]", style: { fontFamily: "Titillium Web, sans-serif" }, children: match.date })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "10", cy: "8.125", r: "2.5", fill: "#7BD0C2", opacity: "0.2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M10 17.5C10 17.5 15.625 13.125 15.625 8.125C15.625 5.01675 13.1083 2.5 10 2.5C6.89175 2.5 4.375 5.01675 4.375 8.125C4.375 13.125 10 17.5 10 17.5Z", stroke: "#7BD0C2", strokeWidth: "1.25", strokeLinecap: "round", strokeLinejoin: "round" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "10", cy: "8.125", r: "2.5", stroke: "#7BD0C2", strokeWidth: "1.25", strokeLinecap: "round", strokeLinejoin: "round" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-[#31363A]", style: { fontFamily: "Titillium Web, sans-serif" }, children: match.city })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "10", cy: "10", r: "6.25", fill: "#7BD0C2", opacity: "0.2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "10", cy: "10", r: "7.5", stroke: "#7BD0C2", strokeWidth: "1.25", strokeLinecap: "round", strokeLinejoin: "round" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M10 6.25V10L12.5 12.5", stroke: "#7BD0C2", strokeWidth: "1.25", strokeLinecap: "round", strokeLinejoin: "round" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-[#31363A]", style: { fontFamily: "Titillium Web, sans-serif" }, children: match.time.local }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-[#31363A]", style: { fontFamily: "Titillium Web, sans-serif" }, children: "-" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base text-[#31363A]", style: { fontFamily: "Titillium Web, sans-serif" }, children: match.time.venue })
      ] })
    ] })
  ] });
};
...
const SidePanel = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `rounded-l-xl flex flex-col p-6 w-[467px] h-[640px] bg-[rgba(81,90,96,0.06)] ${!selectedTeam ? "bg-[url(https://assistcdn.s3.us-west-1.amazonaws.com/assets/wc2026/BallWidthDots.svg)] bg-no-repeat bg-top bg-contain" : ""}`, children: selectedTeam ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-start mb-6 mt-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-[#0059BA] leading-snug", children: "Seleccioná tu equipo para explorar tu camino a la gran final 2026" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: TEAMS.map((team) => /* @__PURE__ */ jsxRuntimeExports.jsx(TeamCard, { team, onClick: setSelectedTeam }, team.id)) })
  ] }) });
};
const Select = ({
  label = null,
  ...
  position = "absolute",
  limit = 0,
  // 0 = default (4 items), >0 = custom limit
  error = null,
  ...props
}) => {
  const [selectedOption, setSelectedOption] = reactExports.useState(null);
  const [isOpen, setIsOpen] = reactExports.useState(false);
  const [dropPosition, setDropPosition] = reactExports.useState("below");
  ...
  reactExports.useEffect(() => {
    if (selectedOption) {
      const optionStillExists = options.find(
        (option) => (option.value ?? option.id) === (selectedOption.value ?? selectedOption.id)
      );
  ...
  const style_select_selected = classNames(
    "bg-white border rounded-xl p-3 select-none transition-colors duration-300 flex justify-between items-center",
    {
      ...
      "border-[#C2DFFF]": !error,
      "border-[#DF563B]": error,
      "focus:outline-none focus:ring-offset-0 focus:ring-2 focus:ring-[#C2DFFF]": !disabled
    }
  );
  const getMaxHeight = () => {
    const itemHeight = 56;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    label && /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: `${style_textfield_label} ${labelClasses}`, children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `relative pt-1 ${classes}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: style_custom_select, ref: selectRef, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            selectedOption ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
              selectedOption.flag && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: selectedOption.flag }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: selectedOption.label ?? selectedOption.name })
            ] }) : placeholder,
      ...
      isOpen && !disabled && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: options.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              className: classNames(style_select_item, {
                "bg-[#F2F2F2] text-[#31363A]": (option.value ?? option.id) === ((selectedOption == null ? void 0 : selectedOption.value) ?? (selectedOption == null ? void 0 : selectedOption.id))
              }),
              children: [
                option.flag && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: option.flag }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: option.label ?? option.name })
              ]
            },
    ...
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-start pl-3 pt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[#E0362A]", children: error }) })
  ] });
};
function App() {
  const [selectedTeam, setSelectedTeam] = reactExports.useState(null);
  const [viewMode, setViewMode] = reactExports.useState("venue");
  const [selectedCity, setSelectedCity] = reactExports.useState(null);
  const [panelTab, setPanelTab] = reactExports.useState("groups");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full min-h-screen flex flex-col bg-[#F2F2F2]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderBar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `w-full max-w-[1366px] mx-auto ${!selectedTeam ? "mt-12" : ""}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 w-full max-w-[1200px] mx-auto", children: [
          selectedTeam && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between gap-6 mt-6 mb-8 font-semibold", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-x-2 items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#31363A] text-xl pr-4", children: "Soy fan de:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Select,
                {
                  placeholder: "Selecioná tu equipo",
                  options: TEAMS,
                  value: selectedTeam == null ? void 0 : selectedTeam.id,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-x-2 items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#31363A] text-xl pr-4", children: "Ver partidos en:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Select,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gap-6 w-full flex justify-center bg-[#F2F2F2]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              MapContainer,
              {
                selectedTeam,
