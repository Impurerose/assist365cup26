      ...
      <div className="w-full max-w-[1366px] mx-auto lg:mt-4 ">
        <div className="max-w-[1200px] mx-auto px-4 lg:px-0">
          ...
          <div className="max-w-[548px] lg:max-w-[792px] mx-auto">
            ...
            {/* Subtítulo */}
            <p className="text-text-default text-lg lg:text-xl pb-4">
          ...
          <div className="lg:max-w-[792px] mx-auto">
            {/* Mapa */}
            <div className="mb-6">
              <ItineraryMapView
        ...
        {/* Grid de ciudades */}
        <div className="w-full max-w-[548px] lg:max-w-[996px] mx-auto mt-10 lg:mt-6">
          <VenuesCityGrid />
        </div>
      </div>
    </div>
