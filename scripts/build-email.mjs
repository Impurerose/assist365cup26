...
console.log('✅ Generando Email Template (HTML con estilos inline)...\n');
...
console.log('📧 Generando email.html...\n');

// ============================================================================
// HTML DEL EMAIL TEMPLATE CON ESTILOS INLINE
// ============================================================================
...
<head>
  ...
  <!-- World Cup 2026 Map - Email Template -->
  <!-- Generated: ${new Date().toISOString()} -->
  
  <title>Tu camino al Mundial empieza acá - Assist 365</title>
        ...
        <table width="718" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; max-width: 718px; position: relative;">
          ...
          <tr>
            <td style="padding: 0 43px;">
              <p style="margin: 0 0 16px 0; font-family: 'Titillium Web', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; color: #181b1d;">
                Ya estás participando del sorteo por un pasaje para viajar y alentar a tu selección en el Mundial 2026 🙌
              </p>
              <p style="margin: 0 0 16px 0; font-family: 'Titillium Web', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; color: #181b1d;">
                Ahora podés continuar explorando la guía mundialista completa y acceder a todo el contenido para organizar tu viaje sede por sede.
              </p>
            </td>
          </tr>
              ...
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td align="center" style="background-color: #006fe8; border-radius: 12px;">
                    ...
                    >
                      <span style="white-space: nowrap;">Ir a la guía completa</span>
          ...
          <tr>
            <td style="padding: 24px 43px 48px 43px;">
              <p style="margin: 0 0 16px 0; font-family: 'Titillium Web', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; color: #181b1d;">
                El viaje de tu vida ya está en juego 🌍⚽
              </p>
...
// 2. Escribir archivo
const emailPath = path.join(distPath, 'email.html');
fs.writeFileSync(emailPath, html);

console.log('✅ HTML del email generado\n');

// 3. Reportar
console.log('📦 Archivo generado:\n');
console.log('  📧 email.html (con estilos inline para clientes de email)\n');

console.log('✅ Build Email completado en: dist-vanilla/email.html\n');
console.log('💡 Para ver: Abrí dist-vanilla/email.html en el navegador\n');
